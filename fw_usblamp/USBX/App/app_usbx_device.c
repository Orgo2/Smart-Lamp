...
/* External HAL PCD handle (defined in Core/Src/main.c) */
extern PCD_HandleTypeDef hpcd_USB_DRD_FS;

/* DCD STM32 initialize function (in case not pulled in by included headers) */
extern UINT _ux_dcd_stm32_initialize(ULONG dcd_io, ULONG parameter);
